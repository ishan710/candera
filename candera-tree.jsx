...
const TREE_BRANCHES = [
  {
    ...
    description:
      "We sit with founders for two days and leave with a plan. What to build, what to buy, what to ignore. The best AI strategy for a small business is usually a small one.",
    samples: [
  ...
  },
  {
    ...
    description:
      "Workshops for teams that want to know how this stuff actually works. We teach without slides about prompting, retrieval, evals, and the difference between the two. Free for libraries and public schools.",
    samples: [
  ...
  },
  {
    ...
    description:
      "When the off-the-shelf answer isn't quite right, we build. Small teams, short engagements, real software you can read. Internal tools, retrieval pipelines, fine-tunes, evals. We ship and we leave good documentation behind.",
    samples: [
  ...
  },
  {
    ...
    description:
      "Short field guides on the AI questions small businesses keep asking us. How to choose a model. How to run an eval. How to write a prompt that won't break in six months. Free to read, free to fork.",
    samples: [
  ...
  },
  {
    ...
    description:
      "A second pair of eyes on the AI parts of your product. Where the model is doing too much. Where the affordances are wrong. Where the trust is leaking. We write a memo, we don't redesign your app.",
    samples: [
  ...
  },
  {
    ...
    description:
      "Help finding, evaluating, and onboarding the first AI engineer for a small team. We've sat on hundreds of these interviews. We know the ten questions worth asking and the thirty that aren't.",
    samples: [
